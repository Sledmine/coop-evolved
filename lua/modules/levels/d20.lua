...
function d20.cutscene_captain(call, sleep)
    ...
    teleportPlayersTo("player0_capt_base")
    ...
    teleportPlayersTo("player0_capt_done")
...
function d20.cutscene_lift(call, sleep)
    ...
    teleportPlayersTo("player0_lift_base")
    hsc.object_destroy("chief")
    ...
    teleportPlayersTo("player0_afterlift_base")
    hsc.object_destroy("chief")
    hsc.object_destroy("rifle")
    hsc.cinematic_stop()
    hsc.camera_control(false)
...
function d20.cutscene_fall(call, sleep)
    ...
    teleportPlayersTo("player0_fall_base")
    hsc.object_destroy("chief")
    hsc.object_destroy("rifle")
    hsc.object_create("chief")
    hsc.object_create("rifle")
    ...
    teleportPlayersTo("player0_afterfall_base")
    hsc.cinematic_stop()
    hsc.camera_control(false)
...
function d20.cutscene_insertion(call, sleep)
    ...
    teleportPlayersTo("player0_insert_base")
    ...
    teleportPlayersTo("chief_insert_base")
