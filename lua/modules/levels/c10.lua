...
return hsc.unit(hsc.list_get(hsc.players()
, 0)
)
end
...
sleep(function() return not (hsc.game_saving()
) end, 1)
...
sleep(function() return not global_dialog_on end)
...
hsc.player_effect_start(hsc.real_random_range(0.7, 0.9)
, 0.1)
end
...
hsc.print("pilot: the last transmission from the captain's dropship was tracked to this location.")
hsc.print("pilot: that was over 12 hours ago and since then no one's been able to raise captain keyes or his team.")
end
...
hsc.print("pilot: i'll mark the last known position of the captain's dropship on your motion sensor")
end
...
hsc.print("pilot: chief is that you!?!  i lost your signal when you disappeared inside the structure.")
...
hsc.print("pilot: there's a tower sticking up out of the fog a few hunder meters from your current location.")
...
hsc.unit_custom_animation_at_frame("chief", "cinematics\\animations\\chief\\x50\\x50", "x50_0710", false, 350)
sleep(10)
...
hsc.custom_animation("mendoza_dead", "cinematics\\animations\\marines\\x50\\x50", "x50_1010mendoza", true)
...
hsc.unit_stop_custom_animation("chief")
hsc.unit_custom_animation_at_frame("chief", "cinematics\\animations\\chief\\x50\\x50", "x50_1010", false, 30)
hsc.unit_custom_animation_at_frame("mendoza_dead", "cinematics\\animations\\marines\\x50\\x50", "x50_1010mendoza", false, 30)
...
hsc.custom_animation("mendoza_dead", "cinematics\\animations\\marines\\x50\\x50", "x50_1210mendoza", false)
hsc.camera_set("mendoza_swing_1a", 0)
hsc.camera_set("mendoza_swing_1b", 60)
sleep(hsc.unit_get_custom_animation_time("chief")
)
hsc.unit_custom_animation_at_frame("chief", "cinematics\\animations\\chief\\x50\\x50", "x50_1310", false, 50)
hsc.unit_custom_animation_at_frame("mendoza_dead", "cinematics\\animations\\marines\\x50\\x50", "x50_1310mendoza", false, 50)
...
hsc.custom_animation("mendoza_dead", "cinematics\\animations\\marines\\x50\\x50", "x50_1410mendoza", true)
...
sleep(hsc.recording_time("chief_crouch")
 - 15
)
...
sleep(15)
hsc.effect_new_on_object_marker("cinematics\\effects\\cyborg chip insertion", "chief", "left hand")
sleep(15)
...
hsc.print("johnson: watch yer mouth, boy! this 'stuff' is your history. it should remind you grunts what we're fighting to protect!")
...
hsc.print("mendoza: hey, if the covenant want to wipe out this particular part of my history, that's fine by me.")
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\men02")
 - 15
)
hsc.print("mendoza done")
...
hsc.print("johnson: you ask 'em real nice next time you see 'em, bisenti. i'm sure they'll be happy to oblige.")
...
sleep(150)
hsc.custom_animation("johnson", "cinematics\\animations\\marines\\x50\\x50", "x50_3210johnson", true)
...
hsc.custom_animation("mendoza", "cinematics\\animations\\marines\\x50\\x50", "x50_3410mendoza", true)
...
hsc.print("mendoza: i'll try, sir. but it looks like these covenant tried pretty hard to lock it down.")
...
hsc.print("done")
hsc.custom_animation("mendoza", "cinematics\\animations\\marines\\x50\\x50", "x50_3310bisenti", true)
...
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\sgt11")
 - 30
)
hsc.print("done")
hsc.sound_impulse_start("sound\\dialog\\x50\\mar101", "none", 1)
hsc.custom_animation("johnson", "cinematics\\animations\\marines\\x50\\x50", "x50_3810johnson", true)
...
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\key05")
 - 30
)
hsc.print("done")
...
hsc.print("marine 1: we got contacts! lots of them! but they're not <static> just tearing through us!")
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\mar102")
 - 30
)
hsc.print("done")
...
hsc.print("johnson: mendoza, get your ass up to 2nd squad's position, and find out what the hell is going on.")
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\sgt14")
 - 30
)
hsc.print("done")
hsc.sound_impulse_start("sound\\dialog\\x50\\men12", "mendoza", 1)
hsc.print("mendoza: but, sir--")
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\men12")
 - 15
)
hsc.print("done")
...
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\sgt15")
 - 30
)
hsc.print("done")
...
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\sgt16")
 - 30
)
hsc.print("done")
...
sleep(30)
hsc.custom_animation("infection_1", "cinematics\\animations\\flood_infection\\x50\\x50", "x50_4110flood", true)
hsc.custom_animation("marine_2", "cinematics\\animations\\marines\\x50_normal\\x50_normal", "x50_4110mar2", true)
sleep(60)
hsc.sound_impulse_start("sound\\dialog\\x50\\mar201", "marine_2", 1)
hsc.print("marine 2: gaah!")
sleep(40)
hsc.custom_animation("bisenti", "cinematics\\animations\\marines\\x50\\x50", "x50_4110bisenti", true)
hsc.sound_impulse_start("sound\\dialog\\x50\\mar202", "marine_2", 1)
hsc.print("marine 2: get it out! get-it-out!")
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\mar202")
 - 60
)
hsc.print("done")
...
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\bis06")
 - 30
)
...
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\key07")
 - 30
)
...
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\men16")
 - 30
)
...
hsc.custom_animation("mendoza", "cinematics\\animations\\marines\\x50\\x50", "x50_4110mendoza", false)
sleep(30)
...
hsc.object_destroy("mendoza")
sleep(hsc.sound_impulse_time("sound\\dialog\\x50\\key08")
 - 15
)
...
hsc.custom_animation("mendoza", "cinematics\\animations\\marines\\x50\\x50", "x50_4110mendoza", true)
hsc.custom_animation("keyes", "cinematics\\animations\\marines\\x50\\x50", "x50_4110captain", true)
end
...
sleep(30)
hsc.switch_bsp(2)
hsc.object_teleport(call(c10.player0)
, "player0_int_base")
hsc.object_teleport(call(c10.player1)
, "player1_int_base")
hsc.unit_suspended(call(c10.player0)
, true)
hsc.unit_suspended(call(c10.player1)
, true)
...
hsc.switch_bsp(5)
hsc.object_teleport(call(c10.player0)
, "player0_extract_base")
hsc.object_teleport(call(c10.player1)
, "player1_extract_base")
hsc.unit_suspended(call(c10.player0)
, true)
hsc.unit_suspended(call(c10.player1)
, true)
...
hsc.custom_animation("chief_extraction", "cinematics\\animations\\chief\\level_specific\\c10\\c10", "c10seemonitor", false)
sleep(90)
...
hsc.print("monitor: greetings. i am the monitor of installation zero four. i am 342 guilty spark.")
...
hsc.custom_animation("chief_extraction", "cinematics\\animations\\chief\\level_specific\\c10\\c10", "c10inspectmonitor", false)
sleep(hsc.sound_impulse_time("sound\\dialog\\c10\\c10_extract_010_monitor")
)
...
hsc.print("monitor: unfortunate. someone has released the flood. it will be necessary for us to activate the installation's containment measures. please come with me.")
...
hsc.print("monitor: it is the nature of the flood to spread. my function is to prevent it from leaving this installation, but i require your assistance.")
...
sleep(function() return hsc.structure_bsp_index()
 == 3
 end, 1)
...
if tracker_x50 then
hsc.begin({
function() return sleep(1)
 end})
else
if hsc.structure_bsp_index()
 == 0
 then
hsc.begin({
function() hsc.begin({
function() if tracker_bsp_index ~= 1
 then
hsc.ai_erase_all()
end
 end,
function() return hsc.garbage_collect_now()
 end,
function() return hsc.object_destroy_containing("biped")
 end,
function() return hsc.object_create_anew_containing("bsp0_biped")
 end,
function() return hsc.object_destroy_containing("device")
 end,
function() return hsc.object_create_anew_containing("bsp0_device")
 end,
function() tracker_bsp_index = 0
 end})
 end})
else
if hsc.structure_bsp_index()
...
function() return hsc.object_create_anew_containing("bsp1_biped")
 end,
function() return hsc.object_destroy_containing("device")
 end,
function() return hsc.object_create_anew_containing("bsp1_device")
 end,
function() tracker_bsp_index = 1
 end})
 end})
else
if hsc.structure_bsp_index()
...
function() return hsc.object_create_anew_containing("bsp2_biped")
 end,
function() return hsc.object_destroy_containing("device")
 end,
function() return hsc.object_create_anew_containing("bsp2_device")
 end,
function() tracker_bsp_index = 2
 end})
 end})
else
if hsc.structure_bsp_index()
...
hsc.begin({
function() hsc.begin({
function() if tracker_bsp_index ~= 4
 then
hsc.ai_erase_all()
end
 end,
...
function() return hsc.object_create_anew_containing("bsp3_biped")
 end,
function() return hsc.object_destroy_containing("device")
 end,
function() return hsc.object_create_anew_containing("bsp3_device")
 end,
function() tracker_bsp_index = 3
 end})
 end})
else
if hsc.structure_bsp_index()
...
hsc.begin({
function() hsc.begin({
function() if tracker_bsp_index ~= 3
 then
hsc.ai_erase_all()
end
 end,
...
function() return hsc.object_create_anew_containing("bsp4_biped")
 end,
function() return hsc.object_destroy_containing("device")
 end,
function() return hsc.object_create_anew_containing("bsp4_device")
 end,
function() tracker_bsp_index = 4
 end})
 end})
else
if hsc.structure_bsp_index()
...
hsc.begin({
function() hsc.begin({
function() return hsc.ai_erase_all()
 end,
function() return hsc.garbage_collect_now()
 end,
function() return hsc.object_destroy_containing("biped")
 end,
function() return hsc.object_create_anew_containing("bsp5_biped")
 end,
function() return hsc.object_destroy_containing("device")
 end,
function() return hsc.object_create_anew_containing("bsp5_device")
 end,
function() tracker_bsp_index = 5
 end})
 end})
else
if true then
...
sleep(function() return play_music_c10_01 end)
hsc.print("levels\\c10\\music\\c10_01")
hsc.sound_looping_start("levels\\c10\\music\\c10_01", "none", 1)
sleep(function() return not play_music_c10_01 or play_music_c10_01_alt end, 1, global_delay_music / 2
)
if play_music_c10_01_alt then
hsc.sound_looping_set_alternate("levels\\c10\\music\\c10_01", true)
end
sleep(function() return not play_music_c10_01 end, 1, global_delay_music / 2
)
...
sleep(function() return play_music_c10_02 end)
hsc.print("levels\\c10\\music\\c10_02")
hsc.sound_looping_start("levels\\c10\\music\\c10_02", "none", 1)
sleep(function() return not play_music_c10_02 or play_music_c10_02_alt end, 1, global_delay_music / 2
)
if play_music_c10_02_alt then
hsc.sound_looping_set_alternate("levels\\c10\\music\\c10_02", true)
end
sleep(function() return not play_music_c10_02 end, 1, global_delay_music / 2
)
...
sleep(function() return play_music_c10_03 end)
hsc.print("levels\\c10\\music\\c10_03")
hsc.sound_looping_start("levels\\c10\\music\\c10_03", "none", 1)
sleep(function() return not play_music_c10_03 or play_music_c10_03_alt end, 1, global_delay_music / 2
)
if play_music_c10_03_alt then
hsc.sound_looping_set_alternate("levels\\c10\\music\\c10_03", true)
end
sleep(function() return not play_music_c10_03 end, 1, global_delay_music / 2
)
...
sleep(function() return play_music_c10_04 end)
hsc.print("levels\\c10\\music\\c10_04")
hsc.sound_looping_start("levels\\c10\\music\\c10_04", "none", 1)
sleep(function() return not play_music_c10_04 or play_music_c10_04_alt end, 1, global_delay_music / 2
)
if play_music_c10_04_alt then
hsc.sound_looping_set_alternate("levels\\c10\\music\\c10_04", true)
end
sleep(function() return not play_music_c10_04 end, 1, global_delay_music / 2
)
...
sleep(function() return play_music_c10_05 end)
hsc.print("levels\\c10\\music\\c10_05")
hsc.sound_looping_start("levels\\c10\\music\\c10_05", "none", 1)
sleep(function() return not play_music_c10_05 or play_music_c10_05_alt end, 1, global_delay_music / 2
)
if play_music_c10_05_alt then
hsc.sound_looping_set_alternate("levels\\c10\\music\\c10_05", true)
end
sleep(function() return not play_music_c10_05 end, 1, global_delay_music / 2
)
...
sleep(function() return play_music_c10_06 end)
hsc.print("levels\\c10\\music\\c10_06")
hsc.sound_looping_start("levels\\c10\\music\\c10_06", "none", 1)
sleep(function() return not play_music_c10_06 or play_music_c10_06_alt end, 1, global_delay_music / 2
)
if play_music_c10_06_alt then
hsc.sound_looping_set_alternate("levels\\c10\\music\\c10_06", true)
end
sleep(function() return not play_music_c10_06 end, 1, global_delay_music / 2
)
...
sleep(function() return play_music_c10_07 end)
hsc.print("levels\\c10\\music\\c10_07")
hsc.sound_looping_start("levels\\c10\\music\\c10_07", "none", 1)
sleep(function() return not play_music_c10_07 or play_music_c10_07_alt end, 1, global_delay_music / 2
)
if play_music_c10_07_alt then
hsc.sound_looping_set_alternate("levels\\c10\\music\\c10_07", true)
end
sleep(function() return not play_music_c10_07 end, 1, global_delay_music / 2
)
...
sleep(function() return hsc.game_safe_to_save()
 end)
hsc.show_hud(false)
hsc.cinematic_show_letterbox(true)
sleep(30)
...
sleep(1)
hsc.unit_enter_vehicle(call(c10.player0)
, "insertion_pelican", "p-riderlf")
hsc.unit_enter_vehicle(call(c10.player1)
, "insertion_pelican", "p-riderrf")
...
, false)
hsc.game_save_totally_unsafe()
sleep(function() return hsc.ai_conversation_status("insertion")
 > 4
 end, 12, 30 * 12
)
sleep(30)
...
sleep(function() return hsc.volume_test_objects("swamp_b_trigger_b", hsc.players()
)
 end)
hsc.game_save()
end
...
sleep(function() return hsc.volume_test_objects("inc_log", hsc.players()
)
 end)
hsc.ai_place("inc_swamp/log_incident")
hsc.unit_impervious(hsc.ai_actors("inc_swamp/log_incident")
, true)
...
sleep(function() return hsc.volume_test_objects("inc5", hsc.players()
)
 end)
hsc.ai_place("inc_swamp/inc7")
hsc.unit_impervious(hsc.ai_actors("inc_swamp/inc7")
, true)
...
sleep(function() return hsc.volume_test_objects("inc6", hsc.players()
)
 end)
hsc.ai_place("inc_swamp/inc6")
hsc.unit_impervious(hsc.ai_actors("inc_swamp/inc6")
, true)
...
sleep(function() return hsc.volume_test_objects("inc5", hsc.players()
 ...
 or hsc.volume_test_objects("inc5b", hsc.players()
)
 end)
hsc.ai_place("inc_swamp/inc5")
hsc.unit_impervious(hsc.ai_actors("inc_swamp/inc5")
, true)
...
sleep(function() return hsc.volume_test_objects("inc4", hsc.players()
)
 end)
hsc.ai_place("inc_swamp/inc4")
hsc.unit_impervious(hsc.ai_actors("inc_swamp/inc4")
, true)
...
sleep(function() return hsc.volume_test_objects("inc3", hsc.players()
)
 end)
hsc.ai_place("inc_swamp/inc3")
hsc.unit_impervious(hsc.ai_actors("inc_swamp/inc3")
, true)
...
sleep(function() return hsc.volume_test_objects("enc_swamp2", hsc.players()
)
 end)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("pelican_radio", hsc.players()
)
 or hsc.volume_test_objects("enc_swamp1", hsc.players()
)
 end, 1)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("enc_swamp1", hsc.players()
)
 end, 1)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.objects_can_see_flag(hsc.players()
, "swamp_a_flood_a", 30)
 end)
hsc.ai_place("swamp_a_flood/flood_a")
hsc.object_cannot_take_damage(hsc.ai_actors("swamp_a_flood")
)
hsc.unit_impervious(hsc.ai_actors("swamp_a_flood")
, true)
end

function c10.ini_see_flood_b(call, sleep)
sleep(function() return hsc.volume_test_objects_all("swamp_a_flood_trigger_a", hsc.players()
)
 and hsc.objects_can_see_flag(hsc.players()
, "swamp_a_flood_b", 20)
 end)
...
sleep(function() return hsc.device_get_position("lift_a_falling")
 ~= 0
 end)
...
sleep(function() return hsc.volume_test_objects("hall_b_bottom_trigger", hsc.players()
)
 end)
...
sleep(function() return hsc.volume_test_objects("lift_a_flood_trigger", hsc.players()
)
 end)
wake(c10.enc_int_a_lift_a_flood)
sleep(function() return hsc.ai_living_count("int_a_flood/lift_a")
 == 0
 end)
hsc.game_save_no_timeout()
end
...
sleep(function() return hsc.volume_test_objects("lift_b_flood_trigger", hsc.players()
)
 end)
wake(c10.enc_int_a_lift_b_flood)
sleep(function() return hsc.ai_living_count("int_a_flood/lift_b")
 == 0
 end)
hsc.game_save_no_timeout()
end
...
if hsc.game_is_cooperative()
 or hsc.game_difficulty_get()
 == impossible
 then
...
sleep(function() return hsc.volume_test_objects("hall_d_bash_trigger", hsc.players()
)
 end)
...
sleep(function() return hsc.volume_test_objects("hall_d_top_trigger", hsc.players()
)
 or hsc.volume_test_objects("hall_d_bottom_trigger", hsc.players()
)
 end)
wake(c10.enc_int_b_lab_b_flood)
sleep(function() return hsc.ai_living_count("int_c_flood/lab_b")
 == 0
 end)
hsc.game_save_no_timeout()
end
...
sleep(function() return hsc.volume_test_objects("hall_d_bottom_trigger", hsc.players()
)
 end)
...
hsc.game_save_no_timeout()
sleep(function() return hsc.volume_test_objects("suicidal_trigger", hsc.players()
)
 or hsc.objects_can_see_object(hsc.players()
, "marine_suicidal", 15)
 end, 1)
sleep(function() return hsc.volume_test_objects("suicidal_trigger", hsc.players()
)
...
sleep(60)
if hsc.ai_living_count("int_b_crazy_marine/crazy_marine")
 == 0
 then
sleep(-1)
end
hsc.sound_impulse_start("sound\\dialog\\c10\\c10_050_crazymarine", "marine_suicidal", 1)
sleep(function() return hsc.ai_living_count("int_b_crazy_marine/crazy_marine")
 == 0
...
sleep(90)
hsc.units_set_current_vitality(hsc.ai_actors("int_c_marines/bay_a")
, 0.5, 0)
sleep(60)
sleep(85)
...
sleep(function() return hsc.volume_test_objects("int_b_hall_a_trigger", hsc.players()
)
 or hsc.volume_test_objects("int_b_hall_a_trigger_b", hsc.players()
)
 end)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("int_b_hall_b_trigger", hsc.players()
)
 end, 10)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("int_b_hall_d_trigger", hsc.players()
)
 end, 10)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("int_b_hall_e_trigger", hsc.players()
)
 or hsc.volume_test_objects("int_b_hall_e_trigger_b", hsc.players()
)
 end)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("int_b_hall_f_trigger", hsc.players()
)
 end, 10)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("int_b_hall_g_trigger", hsc.players()
)
 end, 10)
hsc.game_save_no_timeout()
...
if hsc.ai_living_count("swamp_b_flood")
 <= swamp_b_limiter
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_a")
 end,
function() if debug then
hsc.print("placing flood a")
end
 end,
function() return hsc.ai_place("swamp_b_flood/flood_m")
 end,
function() if debug then
hsc.print("placing flood m")
end
 end,
function() return hsc.ai_place("swamp_b_flood/flood_n")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_infection")
 <= swamp_b_infection_limiter
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_infection/infection_a1")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_flood")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_b")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_infection")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_infection/infection_a2")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_flood")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_c")
 end,
function() if debug then
...
function() return hsc.ai_place("swamp_b_flood/flood_l")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_infection")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_infection/infection_b")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_flood")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_d")
 end,
function() if debug then
hsc.print("placing flood d")
end
 end,
function() return hsc.ai_place("swamp_b_flood/flood_e")
 end,
function() if debug then
hsc.print("placing flood e")
end
 end,
function() if false == hsc.volume_test_objects("swamp_b_trigger_d", hsc.players()
)

 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_p_c")
 end,
function() if debug then
...
function() if false == hsc.volume_test_objects("swamp_b_trigger_f", hsc.players()
)

 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_r_c")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_infection")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_infection/infection_c")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_flood")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_f")
 end,
function() if debug then
hsc.print("placing flood f")
end
 end,
function() return hsc.ai_place("swamp_b_flood/flood_g")
 end,
function() if debug then
hsc.print("placing flood g")
end
 end,
function() if false == hsc.volume_test_objects("swamp_b_trigger_c", hsc.players()
)

 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_o_d")
 end,
function() if debug then
...
function() if false == hsc.volume_test_objects("swamp_b_trigger_e", hsc.players()
)

 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_q_d")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_infection")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_infection/infection_d")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_flood")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_h")
 end,
function() if debug then
hsc.print("placing flood h")
end
 end,
function() return hsc.ai_place("swamp_b_flood/flood_i")
 end,
function() if debug then
...
function() if false == hsc.volume_test_objects("swamp_b_trigger_d", hsc.players()
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_p_e")
 end,
function() if debug then
...
function() if false == hsc.volume_test_objects("swamp_b_trigger_f", hsc.players()
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_r_e")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_infection")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_infection/infection_e")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_flood")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_j")
 end,
function() if debug then
hsc.print("placing flood j")
end
 end,
function() return hsc.ai_place("swamp_b_flood/flood_k")
 end,
function() if debug then
...
function() if false == hsc.volume_test_objects("swamp_b_trigger_c", hsc.players()
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_o_f")
 end,
function() if debug then
...
function() if false == hsc.volume_test_objects("swamp_b_trigger_e", hsc.players()
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_flood/flood_q_f")
 end,
function() if debug then
...
if hsc.ai_living_count("swamp_b_infection")
 ...
 then
hsc.begin({
function() return hsc.ai_place("swamp_b_infection/infection_f")
 end,
function() if debug then
...
sleep(function() return hsc.volume_test_objects("gogogo_trigger", hsc.players()
)
 or hsc.ai_conversation_status("swamp_b")
 > 4
 end, 1)
play_music_c10_07 = true
hsc.ai_migrate("swamp_b_marines", "swamp_b_marines/b")
sleep(function() return hsc.volume_test_objects("swamp_b_trigger_a1", hsc.players()
)
 end, 1, 120)
...
sleep(function() return hsc.volume_test_objects("swamp_b_trigger_a2", hsc.players()
)
 end, 1, 150)
...
sleep(function() return hsc.volume_test_objects("swamp_b_trigger_c", hsc.players()
)
 end, 1)
hsc.ai_migrate("swamp_b_marines", "swamp_b_marines/l")
...
if hsc.volume_test_objects("swamp_b_trigger_a2", hsc.players()
)
 then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_a2)
 end})
else
if true then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_a1)
 end})
end
end
end
...
if hsc.volume_test_objects("swamp_b_trigger_a1", hsc.players()
)
 then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_a1)
...
if hsc.volume_test_objects("swamp_b_trigger_c", hsc.players()
)
 then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_c)
 end})
else
if true then
hsc.begin({
...
if true then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_b)
 end})
end
end
end
...
if hsc.volume_test_objects("swamp_b_trigger_b", hsc.players()
)
 then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_b)
...
if hsc.volume_test_objects("swamp_b_trigger_d", hsc.players()
)
 then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_d)
 end})
else
if hsc.volume_test_objects("swamp_b_trigger_f", hsc.players()
)
 then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_f)
 end})
else
if true then
hsc.begin({
...
if hsc.volume_test_objects("swamp_b_trigger_e", hsc.players()
)
 then
hsc.begin({
function() return call(c10.enc_swamp_b_volume_e)
 end})
else
if true then
hsc.begin({
...
sleep(function() return hsc.volume_test_objects("int_a_trigger_3", hsc.players()
)
 end, 1)
hsc.device_set_position("lift_a", 0)
sleep(function() return hsc.device_get_position("lift_a")
 == 0
 end, 1)
hsc.game_save_no_timeout()
sleep(function() return hsc.volume_test_objects("int_a_trigger", hsc.players()
)
 end, 1)
...
sleep(function() return hsc.volume_test_objects("hall_b_top_trigger", hsc.players()
)
 or hsc.volume_test_objects("hall_b_bottom_trigger", hsc.players()
)
 end)
...
sleep(function() return hsc.volume_test_objects("bayb_trigger", hsc.players()
)
 end, 1)
play_music_c10_02 = true
sleep(function() return hsc.volume_test_objects("control_lab_trigger", hsc.players()
)
 end, 1)
...
hsc.ai_erase_all()
hsc.garbage_collect_now()
if call(c10.cinematic_skip_start)
 then
call(c10.x50)
end
...
sleep(function() return hsc.ai_living_count("int_b_infection")
 < 20
 end, 1)
sleep(function() return hsc.ai_living_count("int_b_infection")
 < 10
...
sleep(function() return not (hsc.volume_test_objects_all("control_check_trigger", hsc.players()
)
) end, 10)
hsc.game_save_no_timeout()
wake(c10.obj_escape)
...
sleep(function() return hsc.volume_test_objects("hall_c_top_trigger", hsc.players()
)
 or hsc.volume_test_objects("hall_c_bottom_trigger", hsc.players()
)
 end)
...
sleep(function() return hsc.volume_test_objects("int_a_ante_a_trigger", hsc.players()
)
 end)
...
sleep(function() return hsc.device_get_position("lift_b")
 ~= 0
 end)
play_music_c10_05 = true
sleep(function() return hsc.volume_test_objects("int_b_hall_a_trigger_b", hsc.players()
)
 end, 1)
...
sleep(function() return hsc.volume_test_objects("int_b_bay_a_trigger", hsc.players()
)
 end, 15)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("int_b_hall_b_trigger", hsc.players()
 ...
 or hsc.volume_test_objects("int_b_hall_b_trigger_b", hsc.players()
)
 end)
hsc.game_save_no_timeout()
wake(c10.enc_int_c_lab_b_flood)
sleep(function() return hsc.volume_test_objects("int_b_hall_c_trigger", hsc.players()
)
 or hsc.volume_test_objects("int_b_hall_c_trigger_b", hsc.players()
)
 end)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("int_b_hall_f_trigger", hsc.players()
 ...
 or hsc.volume_test_objects("int_b_hall_f_trigger_b", hsc.players()
)
 end)
hsc.game_save_no_timeout()
...
sleep(function() return hsc.volume_test_objects("int_b_hall_g_trigger", hsc.players()
 ...
 or hsc.volume_test_objects("int_b_hall_g_trigger_b", hsc.players()
)
 end)
if not (hsc.game_is_cooperative()
) then
hsc.begin({
function() return hsc.object_destroy("last_door_a")
 end,
function() return hsc.object_create("last_bashed_a")
 end,
function() return hsc.device_set_position_immediate("last_bashed_a", 0.4)
 end})
end
hsc.game_save_no_timeout()
...
sleep(30)
sleep(function() return hsc.device_get_position("bridge_e")
 == 1
 end)
hsc.game_save_no_timeout()
hsc.ai_place("int_d_flood/lift_d_rush")
play_music_c10_06_alt = true
sleep(function() return hsc.volume_test_objects("int_b_lift_d_trigger", hsc.players()
)
 end, 1)
hsc.game_save_no_timeout()
hsc.ai_magically_see_players("int_d_flood/lift_d_rush")
wake(c10.enc_int_d_lift_d_flood)
sleep(function() return hsc.device_get_position("lift_d")
 ~= 1
 end, 1)
hsc.game_save_no_timeout()
...
swamp_b_player_locator = 1
if hsc.game_difficulty_get()
 == normal
 then
hsc.begin({
function() swamp_b_limiter = 1
 end,
function() swamp_b_infection_limiter = 6
 end})
else
if hsc.game_difficulty_get()
 == hard
...
function() swamp_b_infection_limiter = 3
 end})
else
if hsc.game_difficulty_get()
 == impossible
 then
hsc.begin({
function() swamp_b_limiter = 2
 end,
function() swamp_b_infection_limiter = 0
 end})
end
end
end
...
sleep(function() return hsc.volume_test_objects("monitor_trigger", hsc.players()
)
 end)
...
sleep(function() return not (hsc.volume_test_objects("swamp_b_trigger_f", hsc.players()
)
 or hsc.volume_test_objects("swamp_b_trigger_c", hsc.players()
)
 or hsc.volume_test_objects("swamp_b_trigger_d", hsc.players()
)
 or hsc.volume_test_objects("swamp_b_trigger_e", hsc.players()
)
) or hsc.ai_living_count("swamp_b_sentinels")
 == 0
 or hsc.ai_living_count("swamp_b_flood/last_wave")
 < 2
 or hsc.unit_get_health(call(c10.player0)
)
 < 0.25
 end, 1, 90 * 30
)
if hsc.game_difficulty_get()
 ~= normal
 or hsc.game_is_cooperative()
 then
sleep(function() return hsc.ai_living_count("swamp_b_sentinels")
 == 0
 or hsc.ai_living_count("swamp_b_flood/last_wave")
 < 2
 end)
...
if hsc.game_is_cooperative()
 ...
 then
hsc.begin({
function() return hsc.object_destroy_containing("shotgun")
 end,
function() return hsc.object_create_containing("arc10")
 end})
end
if not (hsc.game_is_cooperative()
) and hsc.game_difficulty_get_real()
 == easy
 then
...
sleep(function() return hsc.volume_test_objects("int_b_trigger", hsc.players()
)
 end, 5)
wake(c10.mission_int_b)
sleep(function() return hsc.volume_test_objects("killitall", hsc.players()
)
 end, 1)
hsc.ai_erase_all()
sleep(function() return hsc.structure_bsp_index()
...
sleep(function() return test_ffw_flash end, 1)
...
sleep(function() return test_play_flash end, 1)
