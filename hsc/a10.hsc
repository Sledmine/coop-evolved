...
(enable_hud_help_flash true )
(if (player0_joystick_set_is_normal )
        (begin (hud_set_help_text tutorial_moving_1 ))
        (begin (hud_set_help_text tutorial_moving_1l ))
    )
...
(if (= 1 test_looking_cycle )
    (begin (hud_set_help_text tutorial_looking_targeted_2 ))
    (begin (hud_set_help_text tutorial_looking_targeted_3 ))
)
...
(if (player0_look_pitch_is_inverted )
    (begin (sound_impulse_start "sound\dialog\a10\a10_210_cryoassist" none 1 ))
    (begin (sound_impulse_start "sound\dialog\a10\a10_220_cryoassist" none 1 ))
)
...
(script startup mission_a10
    ...
    (object_set_facing (player2 )facing_flag_1 )
    (object_set_facing (player3 )facing_flag_1 )
    (object_set_facing (player4 )facing_flag_1 )
    (object_set_facing (player5 )facing_flag_1 )
    (object_set_facing (player6 )facing_flag_1 )
    (object_set_facing (player7 )facing_flag_1 )
    (object_set_facing (player8 )facing_flag_1 )
    (object_set_facing (player9 )facing_flag_1 )
    (object_set_facing (player10 )facing_flag_1 )
    (object_set_facing (player11 )facing_flag_1 )
    (object_set_facing (player12 )facing_flag_1 )
    (object_set_facing (player13 )facing_flag_1 )
    (object_set_facing (player14 )facing_flag_1 )
    (object_set_facing (player15 )facing_flag_1 )
