...
(object_teleport (player2 )player1_insertion_safe )
(object_teleport (player3 )player1_insertion_safe )
(object_teleport (player4 )player1_insertion_safe )
(object_teleport (player5 )player1_insertion_safe )
(object_teleport (player6 )player1_insertion_safe )
(object_teleport (player7 )player1_insertion_safe )
(object_teleport (player8 )player1_insertion_safe )
(object_teleport (player9 )player1_insertion_safe )
(object_teleport (player10 )player1_insertion_safe )
(object_teleport (player11 )player1_insertion_safe )
(object_teleport (player12 )player1_insertion_safe )
(object_teleport (player13 )player1_insertion_safe )
(object_teleport (player14 )player1_insertion_safe )
(object_teleport (player15 )player1_insertion_safe )
(cinematic_start )
(show_hud false )
(camera_control true )
...
(object_teleport (player2 )player1_extraction_safe )
(object_teleport (player3 )player1_extraction_safe )
(object_teleport (player4 )player1_extraction_safe )
(object_teleport (player5 )player1_extraction_safe )
(object_teleport (player6 )player1_extraction_safe )
(object_teleport (player7 )player1_extraction_safe )
(object_teleport (player8 )player1_extraction_safe )
(object_teleport (player9 )player1_extraction_safe )
(object_teleport (player10 )player1_extraction_safe )
(object_teleport (player11 )player1_extraction_safe )
(object_teleport (player12 )player1_extraction_safe )
(object_teleport (player13 )player1_extraction_safe )
(object_teleport (player14 )player1_extraction_safe )
(object_teleport (player15 )player1_extraction_safe )
...
(script dormant main_b40
    ...
    (game_save_totally_unsafe )
    (if (and (not (game_is_cooperative )) (= normal (game_difficulty_get )))
        (wake help_tank )
    )
    (if (and (not (game_is_cooperative )) (= normal (game_difficulty_get )))
        (wake help_banshee )
