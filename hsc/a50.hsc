...
(object_teleport (player2 )player1_lift_safe )
(object_teleport (player3 )player1_lift_safe )
(object_teleport (player4 )player1_lift_safe )
(object_teleport (player5 )player1_lift_safe )
(object_teleport (player6 )player1_lift_safe )
(object_teleport (player7 )player1_lift_safe )
(object_teleport (player8 )player1_lift_safe )
(object_teleport (player9 )player1_lift_safe )
(object_teleport (player10 )player1_lift_safe )
(object_teleport (player11 )player1_lift_safe )
(object_teleport (player12 )player1_lift_safe )
(object_teleport (player13 )player1_lift_safe )
(object_teleport (player14 )player1_lift_safe )
(object_teleport (player15 )player1_lift_safe )
...
(object_destroy rifle )(sleep (* 30 1 )))
...
(script dormant mission_area5
    ...
    (object_teleport (player2 )gravity_teleport1_flag )
    (object_teleport (player3 )gravity_teleport1_flag )
    (object_teleport (player4 )gravity_teleport1_flag )
    (object_teleport (player5 )gravity_teleport1_flag )
    (object_teleport (player6 )gravity_teleport1_flag )
    (object_teleport (player7 )gravity_teleport1_flag )
    (object_teleport (player8 )gravity_teleport1_flag )
    (object_teleport (player9 )gravity_teleport1_flag )
    (object_teleport (player10 )gravity_teleport1_flag )
    (object_teleport (player11 )gravity_teleport1_flag )
    (object_teleport (player12 )gravity_teleport1_flag )
    (object_teleport (player13 )gravity_teleport1_flag )
    (object_teleport (player14 )gravity_teleport1_flag )
    (object_teleport (player15 )gravity_teleport1_flag )
    (switch_bsp 1 )
