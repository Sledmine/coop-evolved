...
(object_create_anew chief_armed_weapon )
(objects_attach chief_armed "right hand" chief_armed_weapon "" )
...
(fade_out 1 1 1 15 )
(sleep 15 )
(objects_detach chief_armed chief_armed_weapon )
(object_destroy chief_armed )
(object_destroy chief_armed_weapon )
