...
(if (volume_test_objects_all enc5_1_north (players ))(begin (ai_kill enc5_1_sents/south )(if (and (<= (ai_living_count enc5_1_sents )1 )(volume_test_objects enc5_1_main (players )))(begin (sleep 150 )
(if (>= player_is_on_floor 2 )
...
(sleep 300 )(ai_place enc5_1_sents/north )))))(if (volume_test_objects_all enc5_1_south (players ))(begin (ai_kill enc5_1_sents/north )(if (and (<= (ai_living_count enc5_1_sents )1 )(volume_test_objects enc5_1_main (players )))(begin (sleep 150 )
(if (>= player_is_on_floor 2 )
(sound_impulse_start "sound\dialog\d40\d40_monitor_player" (list_get (ai_actors enc5_1_monitor )0 )1 )(sound_impulse_start "sound\dialog\d40\d40_monitor_self" (list_get (ai_actors enc5_1_monitor )0 )1 ))
(sleep 300 )(ai_place enc5_1_sents/south ))))))
...
(enc5_1_monitor_control )(if (or inside_n12 inside_n23 inside_s12 inside_s23 )
