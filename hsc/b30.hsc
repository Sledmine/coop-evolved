...
(script dormant music_b30_01
    ...
    (if play_music_b30_01_alt
        (begin (sound_looping_set_alternate "levels\b30\music\b30_01" true )
...
(script dormant cutscene_insertion
    ...
    (set sync_hsc_command "sync_unit_enter_vehicle player1 insertion_pelican_2 2")
    (set sync_hsc_command "sync_unit_enter_vehicle player2 insertion_pelican_1 3")
    (set sync_hsc_command "sync_unit_enter_vehicle player3 insertion_pelican_2 4")
    (set sync_hsc_command "sync_unit_enter_vehicle player4 insertion_pelican_1 5")
    (set sync_hsc_command "sync_unit_enter_vehicle player5 insertion_pelican_2 6")

    (set sync_hsc_command "sync_unit_enter_vehicle player6 insertion_pelican_1 8")
    (set sync_hsc_command "sync_unit_enter_vehicle player7 insertion_pelican_2 9")
    (set sync_hsc_command "sync_unit_enter_vehicle player8 insertion_pelican_1 10")
    (set sync_hsc_command "sync_unit_enter_vehicle player9 insertion_pelican_2 11")
    
    (set sync_hsc_command "sync_unit_enter_vehicle player10 insertion_pelican_1 1")
    (set sync_hsc_command "sync_unit_enter_vehicle player11 insertion_pelican_2 2")
    (set sync_hsc_command "sync_unit_enter_vehicle player12 insertion_pelican_1 3")
    (set sync_hsc_command "sync_unit_enter_vehicle player13 insertion_pelican_2 4")
    (set sync_hsc_command "sync_unit_enter_vehicle player14 insertion_pelican_1 5")
